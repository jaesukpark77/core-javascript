...
// 원시값은 그대로 복사
let message = '문자 값은 프리미티브 데이터 타입으로 값이 복사됩니다.'; // 원시값은 그대로 복사
let messenger = {
  name: 'kakao talk',
  manufacture: 'kakao'
};
...
conversationTool.name = 'line' // 참조에 의한 복사
...
// 3. 전개 연산자(...)를 사용한 복사
const spreadObject = {...messenger} // 킹짱!!!! 대박!!!
// 4. 객체를 복사해주는 유틸 함수 
const copyFunction = object => Object.assign({}, object)
